		...
		<div class="container">
			<div class="row">
				<div class="block col-md-4 col-sm-6 col-xs-8 col-md-offset-4 col-sm-offset-3 col-xs-offset-2">
					...
					<form class="form-horizontal" id = "frm-login" method = "post" action="{{ route('admin.doLogin') }}">
						@csrf
					  <div class="form-group">
					    <label for="user" class="col-sm-3 control-label">Email</label>
					    <div class="col-sm-9">
					      <input type="text" class="form-control" id="user" name="email" placeholder="Username">
					    </div>
					  </div>
					  <div class="form-group">
